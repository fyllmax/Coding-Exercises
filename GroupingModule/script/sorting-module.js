var SORTING_MODULE = (function() {
  ...
  function sortingCriteria(student, otherStudent) {
    ...
    if (student.available && !otherStudent.available) {return -1;}

    else if (!student.available && otherStudent.available) {return 1;}

    else if (studentCourse < otherStudentCourse) {return -1;}

    else if (studentCourse > otherStudentCourse) {return 1;}

    else if (student.name < otherStudent.name) {return -1;}
